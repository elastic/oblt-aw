...
Target repositories install per-workflow client templates from this repository (for example `trg-oblt-aw-automerge.yml`, `oblt-aw-issue-fixer.yml`). Each template calls a matching `oblt-aw-*` reusable workflow; shared gating runs in [aw-prelude.yml](.github/workflows/aw-prelude.yml).
...
- Docs templates: [.github/remote-workflow-template/docs/.github/workflows/](.github/remote-workflow-template/docs/.github/workflows/) (`trg-docs-aw-ai-menu.yml`, `trg-docs-aw-pr-ai-menu.yml`)
