    ...
    spec:
      ...
      auth:
        ...
        bound_claims:
          ...
          workflow_ref: elastic/<repo>/.github/workflows/oblt-aw-automerge.yml@refs/heads/main
      cached: true
      permissionset:
        additional_permissions: {}
        selector:
