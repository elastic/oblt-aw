...
4. Runs [`scripts/resolve_agentic_assets.py`](../../scripts/resolve_agentic_assets.py) (via [`agentic_assets_resolver.py`](../../scripts/agentic_assets_resolver.py)) with the compound workflow id (`org-key:workflow-id`) to select the org block and produce:
