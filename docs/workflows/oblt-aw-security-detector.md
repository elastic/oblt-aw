...
3. Installs **shellcheck**, **jq**, **curl**, **pip**, **actionlint** (installer script pinned by commit SHA and verified with SHA-256 before execution), **zizmor**, and **semgrep** (registry rules downloaded on first use).
