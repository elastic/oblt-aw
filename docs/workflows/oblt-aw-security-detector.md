...
3. Installs **shellcheck**, **jq**, **curl**, **pip**, **actionlint** (pinned upstream download script commit + SHA-256 verification before execution), **zizmor**, and **semgrep** (registry rules downloaded on first use).
