...
3. Installs **shellcheck**, **jq**, **curl**, **pip**, **actionlint** (download script pinned to commit and verified via SHA-256 before execution), **zizmor**, and **semgrep** (registry rules downloaded on first use).
