...
3. Installs **shellcheck**, **jq**, **curl**, **pip**, **actionlint** (installer script pinned to commit and SHA-256 verified before execution), **zizmor**, and **semgrep** (registry rules downloaded on first use).
