...
3. Installs **shellcheck**, **jq**, **curl**, **pip**, **actionlint** (installer script commit-pinned and SHA-256 verified before execution), **zizmor**, and **semgrep** (registry rules downloaded on first use).
