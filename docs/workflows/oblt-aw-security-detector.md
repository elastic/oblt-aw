...
3. Installs **shellcheck**, **jq**, **curl**, **pip**, **actionlint** (pinned to a versioned release archive with SHA-256 verification of the upstream checksum manifest and archive), **zizmor**, and **semgrep** (registry rules downloaded on first use).
