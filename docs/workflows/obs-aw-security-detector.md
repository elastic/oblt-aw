...
This implements the detector stage of the pipeline in [docs/architecture/security-agent-architecture.md](../architecture/security-agent-architecture.md). Triage and fixer use **`gh-aw-issue-triage.lock.yml`** and **`gh-aw-issue-fixer-workflows.lock.yml`** from [elastic/ai-github-actions](https://github.com/elastic/ai-github-actions).
