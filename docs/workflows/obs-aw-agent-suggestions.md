...
- The nested reusable-workflow call intentionally avoids `secrets: inherit`; token use remains through GitHub's automatic token/context flow plus optional explicit upstream secret contracts.
