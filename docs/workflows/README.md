...
- Observability client templates (`oblt-aw-*.yml` under remote-workflow-template): [docs/workflows/oblt-aw-client-template.md](oblt-aw-client-template.md)
- Docs client templates (`docs-aw-*.yml` under remote-workflow-template): [docs/workflows/docs-aw-client-template.md](docs-aw-client-template.md)
