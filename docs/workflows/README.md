...
This section provides one document per workflow file in `.github/workflows/` and for the client template workflow file.
...
- Workflow source files: `.github/workflows/`
- Remote template source: `.github/remote-workflow-template/oblt-aw.yml`
