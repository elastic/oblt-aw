...
| Docs-only fix prompt, ready-for-review PRs, docs `allowed-files`, and top-level docs `protected-files` excludes in [`gh-aw-create-pr-from-issue.md`](../../.github/workflows/gh-aw-create-pr-from-issue.md) | |
