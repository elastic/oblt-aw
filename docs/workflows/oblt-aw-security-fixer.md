# Workflow: `oblt-aw-security-fixer.yml`

## Overview

Source file: [.github/workflows/oblt-aw-security-fixer.yml](../../.github/workflows/oblt-aw-security-fixer.yml)
...
- Secret: `COPILOT_GITHUB_TOKEN` (optional)
