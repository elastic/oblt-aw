...
Reusable implementation for the Docs issue AI menu. The client template `docs-aw-ai-menu.yml` calls this workflow on supported issue events.

## Prerequisites

- Triggered via `workflow_call` from [docs-aw-ai-menu.yml](../../.github/remote-workflow-template/docs/.github/workflows/docs-aw-ai-menu.yml) (distributed client template).
