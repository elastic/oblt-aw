# Workflow: `oblt-aw-resource-not-accessible-by-integration-detector.yml`

## Overview

Source file: [.github/workflows/oblt-aw-resource-not-accessible-by-integration-detector.yml](../../.github/workflows/oblt-aw-resource-not-accessible-by-integration-detector.yml)
...
2. **search** — Matrix job that calls `oblt-aw-log-searching-agent` per workflow:
