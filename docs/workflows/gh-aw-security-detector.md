...
3. Installs **shellcheck**, **jq**, **curl**, **pip**, **actionlint** (pinned release tarball with SHA-256 verification), **zizmor**, and **semgrep** (registry rules downloaded on first use).
