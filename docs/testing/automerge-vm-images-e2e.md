...
CI for fixture PRs is skipped when label `e2e:automerge-vm-images` is present and the head ref starts with `e2e/automerge-vm-images/`. Agentic pull-request routes are **not** skipped (unlike the ESTC fixture).
