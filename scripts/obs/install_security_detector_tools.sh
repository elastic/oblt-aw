...
curl -fsSLO "${ACTIONLINT_RELEASE_URL}/${ACTIONLINT_TARBALL}"
curl -fsSLO "${ACTIONLINT_RELEASE_URL}/${ACTIONLINT_CHECKSUMS}"
grep -E " ${ACTIONLINT_TARBALL}\$" "${ACTIONLINT_CHECKSUMS}" | sha256sum -c -
