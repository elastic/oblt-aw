...
ACTIONLINT_INSTALLER_PATH="/tmp/gh-aw/agent/download-actionlint-${ACTIONLINT_DOWNLOAD_SCRIPT_SHA}.bash"
curl -fsSL "$ACTIONLINT_INSTALLER_URL" -o "$ACTIONLINT_INSTALLER_PATH"
printf '%s  %s\n' "$ACTIONLINT_DOWNLOAD_SCRIPT_SHA256" "$ACTIONLINT_INSTALLER_PATH" | sha256sum -c -
