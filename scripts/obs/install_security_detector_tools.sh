...
ACTIONLINT_DOWNLOAD_SCRIPT="/tmp/gh-aw/agent/download-actionlint-${ACTIONLINT_DOWNLOAD_SCRIPT_SHA}.bash"
curl -fsSL "https://raw.githubusercontent.com/rhysd/actionlint/${ACTIONLINT_DOWNLOAD_SCRIPT_SHA}/scripts/download-actionlint.bash" -o "${ACTIONLINT_DOWNLOAD_SCRIPT}"
...
rm -f "${ACTIONLINT_DOWNLOAD_SCRIPT}"
